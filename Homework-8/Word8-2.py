...
figure(figsize=(8,6))
plot(z(5)[2],z(5)[1],label="r=5",color="blue",linewidth=2,linestyle='-')
plot(z(10)[2],z(10)[1],label="r=10",color="red",linewidth=2,linestyle='-')
plot(z(25)[2],z(25)[1],label="r=25",color="green",linewidth=2,linestyle='-')
xlabel("x")
